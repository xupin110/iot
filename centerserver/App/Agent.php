...
class Agent
{
    ...
    {
        echo "APP ------ Agent ----------getRobots".PHP_EOL;
        $start = ($page - 1) * $size;
        $end = $start + $size;
        $data = [];
    ...
    public static function getAgents($gets = [], $page = 1, $pagesize = 10)
    {
        ...
        print_r(["total" => $pager->total, "rows" => $list]);
    ...
    {
        echo "APP ------ Agent ----------getAgent".PHP_EOL;
    ...
    {
        echo "APP ------ Agent ----------getAgentByGid".PHP_EOL;
        $agg = table("agent_group");
    ...
    {
        echo "APP ------ Agent ----------addAgent".PHP_EOL;
        if (empty($agent)) {
    ...
    {
        echo "APP ------ Agent ----------updateAgent".PHP_EOL;
    ...
    {
        echo "APP ------ Agent ----------deleteAgent".PHP_EOL;
        if (empty($id)) {
            return Lib\Util::errCodeMsg(101, "参数为空");
        }
