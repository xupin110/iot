...
class SOAProtocol
{
    ...
    {
        echo "Lib ------ SOAProtocol ----------getRequestId\n".PHP_EOL;
    ...
    {
        echo "Lib ------ SOAProtocol ----------setEncodeType\n".PHP_EOL;
        if ($json) {
